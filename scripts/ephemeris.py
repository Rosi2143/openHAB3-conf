...
parser = argparse.ArgumentParser(
    description="read school holidays from https://www.schulferien.org/deutschland/ical/"
)

parser.add_argument(
    "-v", "--verbose", action="store_const", const=1, default=0, help="activate logging"
)
parser.add_argument(
    "-i",
    "--inPath",
    default=os.path.join(OpenHabConf, "html/FerienKalender/"),
            ...
            if component.get("rrule"):
                ...
                for single_date in daterange(startdt, enddt):
                    ...
                    if args.verbose > 1:
                        ...
                        print(month)
                        addString = """\t\t<tns:Fixed month=\"{_month}\" """.format(
                            _month=month
                        )
                        print(addString)
